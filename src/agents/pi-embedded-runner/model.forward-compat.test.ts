...
import {
  ...
  makeModel,
  mockGoogleAntigravityFlashTemplateModel,
  mockGoogleFlashTemplateModel,
...
describe("pi embedded model e2e smoke", () => {
  ...
  it("builds a google-antigravity forward-compat fallback for gemini-3.1-flash-lite-preview", () => {
    mockGoogleAntigravityFlashTemplateModel();
